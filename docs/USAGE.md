<!-- Keep this file semantically aligned with USAGE.zh-CN.md. See ../CLAUDE.md. -->
...
See the full [trigger command reference](../README.md#trigger-command-reference) and [troubleshooting guide](../README.md#troubleshooting) in the README.
